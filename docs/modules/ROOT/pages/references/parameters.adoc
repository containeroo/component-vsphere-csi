...
StorageClasses to render for the vSphere CSI driver.
The keys of this dictionary are only inventory-local identifiers.
The generated Kubernetes object name comes from `storage_classes.<key>.name`.

=== `storage_classes.<name>.enabled`

[horizontal]
type:: boolean
default:: `true`

Whether to render this StorageClass.

=== `storage_classes.<name>.name`

[horizontal]
type:: string
default:: `vsphere-csi` for the built-in `block` class

The Kubernetes `StorageClass.metadata.name`.

=== `storage_classes.<name>.default_class`

[horizontal]
type:: boolean
default:: `false`

If set to `true`, the component adds annotation `storageclass.kubernetes.io/is-default-class: "true"`.

=== `storage_classes.<name>.annotations`

[horizontal]
type:: dictionary
default:: `{}`

Additional annotations for the StorageClass.

=== `storage_classes.<name>.parameters`

[horizontal]
type:: dictionary
default:: `{}`

Parameters passed to the vSphere CSI provisioner.
Common examples are:
...
=== `storage_classes.<name>.allow_volume_expansion`

[horizontal]
type:: boolean
default:: unset

If set, renders `allowVolumeExpansion`.

=== `storage_classes.<name>.reclaim_policy`

[horizontal]
type:: string
default:: unset

If set, renders `reclaimPolicy`.

=== `storage_classes.<name>.volume_binding_mode`

[horizontal]
type:: string
default:: unset

If set, renders `volumeBindingMode`.

== `feature_states`

[horizontal]
type:: dictionary
default:: https://github.com/kubernetes-sigs/vsphere-csi-driver/blob/v3.6.1/manifests/vanilla/vsphere-csi-driver.yaml[Upstream v3.6.1 defaults], excluding the Windows daemon set
...
Defaults follow the upstream v3.6.1 Linux deployment manifest.
...
[horizontal]
type:: dictionary
default:: https://raw.githubusercontent.com/kubernetes-sigs/vsphere-csi-driver/v3.6.1/manifests/vanilla/vsphere-csi-driver.yaml[Upstream v3.6.1 control-plane node affinity]
...
[horizontal]
type:: list
default:: https://github.com/kubernetes-sigs/vsphere-csi-driver/blob/v3.6.1/manifests/vanilla/vsphere-csi-driver.yaml[Upstream control-plane tolerations]
...
[horizontal]
type:: list
default:: https://github.com/kubernetes-sigs/vsphere-csi-driver/blob/v3.6.1/manifests/vanilla/vsphere-csi-driver.yaml[Upstream node tolerations]
