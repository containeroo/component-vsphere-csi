...
[horizontal]
type:: dictionary
default:: https://github.com/kubernetes-sigs/vsphere-csi-driver/blob/v3.7.2/manifests/vanilla/vsphere-csi-driver.yaml[Upstream v3.7.2 defaults], excluding the Windows daemon set
...
Defaults follow the upstream v3.7.2 Linux deployment manifest.
...
[horizontal]
type:: dictionary
default:: https://raw.githubusercontent.com/kubernetes-sigs/vsphere-csi-driver/v3.7.2/manifests/vanilla/vsphere-csi-driver.yaml[Upstream v3.7.2 control-plane node affinity]
...
[horizontal]
type:: list
default:: https://github.com/kubernetes-sigs/vsphere-csi-driver/blob/v3.7.2/manifests/vanilla/vsphere-csi-driver.yaml[Upstream control-plane tolerations]
...
[horizontal]
type:: list
default:: https://github.com/kubernetes-sigs/vsphere-csi-driver/blob/v3.7.2/manifests/vanilla/vsphere-csi-driver.yaml[Upstream node tolerations]
